...
#pragma config(Motor,  port4,           right1,        tmotorVex393_MC29, openLoop, driveRight)
#pragma config(Motor,  port5,           left1,         tmotorVex393_MC29, openLoop, reversed, driveLeft)
...
#pragma config(Motor,  port9,           giraffe,       tmotorVex393_MC29, PIDControl, encoderPort, I2C_1)
